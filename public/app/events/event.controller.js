...
angular
  ...
  function EventController($location,ngDialog,$scope,eventFactory,$rootScope){
  ...
  vm.getEvents = function(){
    eventFactory.getAllEvents()
      .then(function(data){
       ...
       eventFactory.cacheEvents(data.data);
       vm.eventData = eventFactory.getCachedEvents();
      })
      .catch(function(err){
        console.log(err);
      })
  ...
  if (eventFactory.getCachedEvents()  == null){
